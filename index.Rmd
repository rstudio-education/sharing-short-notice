...
...a way to display reuse licenses for your educational content...
...
...a way to list multiple authors and their affiliations.
...
Just like we did with the R Markdown site, we use the build tab to build our distill site.
...
But there is one IMPORTANT change we need to make inside of this file. 
...
.right-column[
![](images/screenshots/build-bookdown.png)
]
...
+ Cross-references, numbered figures, equations, tables
...
.pull-right[
![](images/screenshots/build-blogdown.png)
]
