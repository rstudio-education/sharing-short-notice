...
???
And here's a simple book that we're going to look at more closely.

make simple site to match dir tree in next slide
...
Here on the left you can see the files in the project directory. 
...
<img src="images/site.yml.png" style="position: absolute; width: 62%; top: -23px;">
...
name: bookdown
class:  top, center
background-image: url(mtsalsa-book.jpg)
background-size: contain
background-position: center, bottom
