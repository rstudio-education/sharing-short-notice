...
[arghhh-- why do the visuals "jump" down??]
...
And one of the ways we can do that is by making a course website
...
---
background-image: url(images/rawpixel/bunch-balloons-annotated.jpg)
background-size: contain
