...
```{r, echo=FALSE}
knitr::include_graphics("images/screenshots/build-site.png")
```
]
...
.right-column[
```{r, echo=FALSE}
knitr::include_graphics("images/screenshots/build-site-after.png")
```
]
...
And once we do, this will create a new folder called `_site/`, which will hold all the HTML files that were just knit. 
...
Here is the site we just built. We have a navbar and a theme -- and seeif you notice anything different about the navbar
...
.right-column[
```{r, echo=FALSE}
knitr::include_graphics("images/screenshots/RMD-site1.png")
```

do i need this slide w/ annotation?
...
1. Don't update Hugo during your course.

--

1. Don't update your Hugo theme during your course.

--

1. Seriously, just don't update anything during your course.
