...
Okay, we're finally, ready to share our R MArkdown site -- we'll do this the same way as before. but now - the only files we need to drag and drop are in _site. This this is the only folder, we need to deploy with Netfliy. 
...
(make this a screenshot instead, circle where it says this)
]
